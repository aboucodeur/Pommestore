...
// import { drizzle as drizzleXata, type NodePgClient } from 'drizzle-orm/node-postgres'; // xata driver
...
// const xataClient = new Pool({ connectionString: xata.sql.connectionString }) as NodePgClient;
